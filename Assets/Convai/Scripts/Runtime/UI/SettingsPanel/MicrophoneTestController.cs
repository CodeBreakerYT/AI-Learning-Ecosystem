...
#else
            // UnityEngine.Microphone isn't implemented on WebGL - the mic test UI is a no-op there.
            ConvaiLogger.Warn("Microphone recording isn't supported in WebGL builds.", ConvaiLogger.LogCategory.UI);
#endif
        }
