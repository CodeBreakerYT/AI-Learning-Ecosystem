...
public class Arrow_VR : MonoBehaviour
{
    ...
    {
        if (launched && !stuck && arrow_rb.linearVelocity != Vector3.zero)
            transform.rotation = Quaternion.LookRotation(arrow_rb.linearVelocity);
    }
